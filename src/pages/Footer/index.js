		...
		<div className="container">
			<div className="row">
				<div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
					...
					<div className="footer__lang">
						...
						<ul className="dropdown-menu footer__lang-dropdown" aria-labelledby="dropdownLang">
							<li><Link to="/"><img src="assets/img/flags/spain.svg" alt=""/><span>Spanish</span></Link></li>
							<li><Link to="/"><img src="assets/img/flags/russia.svg" alt=""/><span>Russian</span></Link></li>
							<li><Link to="/"><img src="assets/img/flags/china.svg" alt=""/><span>Chinese</span></Link></li>
						</ul>
					</div>
				</div>
				...
				<div className="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
					...
					<div className="footer__nav">
						<Link to="token.html">Unitok</Link>
