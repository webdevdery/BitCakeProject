					...
					<div className="row row--grid">
						...
						<div className="col-12 col-sm-6 col-lg-4 col-xl-3">
							...
							<div className="card">
								<div className="card__cover card__cover--carousel owl-carousel">
									<img src="assets/img/cover/slide1.jpg" alt=""/>
									<img src="assets/img/cover/slide2.jpg" alt=""/>
									<img src="assets/img/cover/slide3.jpg" alt=""/>
								</div>
						...
						<div className="col-12 col-sm-6 col-lg-4 col-xl-3">
							...
							<div className="card">
								...
								<h3 className="card__title"><a href="#modal-asset" className="open-modal">Flowers in Concrete (Modal)</a></h3>
								<div className="card__author">
