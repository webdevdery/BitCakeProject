      ...
      <div className="container">
        ...
        {/* <!-- end explore --> */}
          ...
          <div className="sign__group sign__group--row">
            <label className="sign__label" for="placebid">Your Highest bid</label>
            <input id="placebid" type="text" name="placebid" placeholder="Place your highest bid in BNB." className="sign__input"/>
            <span className="sign__text sign__text--small">Price in USD : 500</span>            
            <span className="sign__text sign__text--small">Starting Bid : 2</span>
          </div>
