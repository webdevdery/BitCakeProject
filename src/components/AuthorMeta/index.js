...
function AuthorMeta(props) {
  ...
  return (
    <div className="author__meta">
      ...
      <h1 className="author__name"><a href="/author">{authorName}</a></h1>
      <h2 className="author__nickname"><a href="/author">{nickName}</a></h2>
