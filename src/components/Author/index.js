...
function Author(props) {
  ...
  return (
    <div className="author">
      <a href="/creator" className="author__cover author__cover--bg" data-bg={bgImage}>
      </a>
      <div className="author__meta">
        <a href="/creator" className="author__avatar author__avatar--verified">
          <img src={avatar} alt=""/>
        </a>
        <h3 className="author__name"><a href="/creator">{authorName}</a></h3>
        <h3 className="author__nickname"><a href="/creator">{nickName}</a></h3>
